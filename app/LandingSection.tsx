  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center max-w-4xl mx-auto px-4">
        <h1
          className={`text-5xl md:text-7xl font-bold leading-tight tracking-tighter drop-shadow-lg ${
            isLightBg ? "text-primary" : "text-primary-foreground"
          }`}
        >
        ...
        >
          Join group deals on your favorite products. The more people that join,
          the bigger the discount for everyone.
        </p>
        <p
          className={`mt-6 text-lg md:text-xl max-w-2xl drop-shadow-md ${
