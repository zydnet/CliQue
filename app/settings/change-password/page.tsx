  ...
  if (!user) {
    return (
      <div className="max-w-md mx-auto mt-16 p-6 text-center">
        ...
        <p className="mb-4">You must be signed in to change your password.</p>
        <Link href="/auth">
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-6">
      <Card className="p-6">
        <h2 className="text-xl font-semibold mb-4">Change Password</h2>
        {success ? (
          <div className="text-green-600 mb-4">Password updated successfully!</div>
        ) : (
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <Input type="password" value={newPassword} onChange={e => setNewPassword(e.target.value)} required disabled={loading} autoComplete="new-password" />
            </div>
